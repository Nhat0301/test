...
import { exportInternalMedToDocx } from '../services/docxService';
...
interface InternalMedFormProps {
  onBack: () => void;
  isAiEnabled: boolean;
}
      ...
      <div className="flex-1 overflow-auto bg-gray-800/50 p-4 md:p-8 print-scroll-container" id="print-modal-container">
         <div className="min-w-fit min-h-full flex justify-center items-start">
            <div id="print-content" className="bg-white shadow-2xl flex-shrink-0 text-black box-border origin-top" style={{ width: '210mm', minHeight: '297mm', padding: '20mm', fontFamily: '"Times New Roman", Times, serif' }}>
              ...
              <h1 className="text-center font-bold text-[18pt] mb-8 mt-4 uppercase leading-[1.5]">BỆNH ÁN NỘI KHOA</h1>
...
export const InternalMedForm: React.FC<InternalMedFormProps> = ({ onBack, isAiEnabled }) => {
    ...
    <div className="max-w-5xl mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 sticky top-0 bg-gray-50/95 dark:bg-slate-900/95 backdrop-blur-md z-40 py-4 border-b border-gray-200 dark:border-slate-800 shadow-sm px-1 rounded-b-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800 dark:text-slate-200 tracking-tight">Bệnh Án Nội Khoa</h1>
          </div>
        </div>
        <div className="flex gap-3">
           ...
           <button onClick={() => exportInternalMedToDocx(data)} className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:shadow-indigo-300 font-bold shadow-lg flex items-center gap-2 transition-transform active:scale-95">
